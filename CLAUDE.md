...
> **実装・ファイル変更・コマンド実行を一切行う前に、必ず計画を立ててユーザーの承認を得ること。**

#### 0-1. 計画作成（ユーザーへの提示・承認）

以下の内容を含む計画を作成し、ユーザーに提示すること：
...
**ユーザーが計画を承認するまで、いかなる実装作業も開始してはならない。**

#### 0-2. Issue 作成

計画承認後、GitHub Issue を作成する：

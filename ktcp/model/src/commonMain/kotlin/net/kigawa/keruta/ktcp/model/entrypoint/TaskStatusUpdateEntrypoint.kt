...
class TaskStatusUpdateEntrypoint : Entrypoint<TaskStatusUpdateMessage, KtcpMessage> {
    override val info = EntrypointInfo("task_status_update", emptyList(), "タスク状態更新処理")
